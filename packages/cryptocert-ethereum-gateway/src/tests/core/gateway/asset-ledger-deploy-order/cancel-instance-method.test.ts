...
spec.test(
  "marks xcertDeployGateway deploy as canceled on the network which prevents the deploy from being performed",
  async (ctx) => {
    ...
    const xcertDeployGatewayBob = new Gateway(bobGenericProvider, {
      actionsOrderId: "",
