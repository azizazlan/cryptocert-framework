...
import { AssetSetOperatorOrder } from "cryptocert/scaffold";
...
export function normalizeOrderIds(
  ...
  order.tokenTransferData.receiverId = order.tokenTransferData.receiverId
    ? provider.encoder.normalizeAddress(order.tokenTransferData.receiverId)
    : ZERO_ADDRESS;
