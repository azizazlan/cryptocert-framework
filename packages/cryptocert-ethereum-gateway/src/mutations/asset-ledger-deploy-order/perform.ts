...
const inputTypes = [
  "tuple(address, address, tuple(string, string, string, string, bytes32, bytes4[], address), tuple(address, address, uint256), uint256, uint256)",
...
export default async function (
  ...
  const functionSignature =
    order.takerId === ZERO_ADDRESS ? "0xef48e40c" : "0xb2a9e276"; // performAnyTaker or perform
